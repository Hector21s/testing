...
export class LinearRegressionService {
  test1 = 'https://model-service-hector21s.cloud.okteto.net/3a1';
  test2 = 'https://model-service-hector21s.cloud.okteto.net/3a2';
  test3 = 'https://model-service-hector21s.cloud.okteto.net/3a3';
  test4 = 'https://model-service-hector21s.cloud.okteto.net/3a4';
